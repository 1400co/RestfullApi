...
namespace Template.Infrastructure.Data
{
    public partial class TemplateContext : DbContext
    {
        ...
        //{
        //    optionsBuilder.UseSqlServer("Server=localhost;Initial Catalog=Template;Persist Security Info=False;User ID=sa;Password=Pass@Word;Connection Timeout=30;TrustServerCertificate=True");
        //}
        ...
        //    {
        //        optionsBuilder
        //        .UseNpgsql("host=localhost;port=5432;database=Template;username=opinor_crm;password=opinor_crm");
        //    }
        //}
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            if (!optionsBuilder.IsConfigured)
            {
                optionsBuilder.EnableSensitiveDataLogging().UseNpgsql("host=localhost;port=5433;database=Template;username=admin_postgres;password=XPa8exBDAH6SzxkC");
